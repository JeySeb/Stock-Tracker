...
func TestStock_IsRecommendation(t *testing.T) {
	testCases := []struct {
		...
		{
			name:       "Strong Buy rating - positive",
			action:     "upgraded by Goldman Sachs",
			ratingFrom: "Hold",
			ratingTo:   "Strong Buy",
			expected:   true,
		...
		{
			name:       "Outperform rating - positive",
		...
		{
			name:       "Hold rating - neutral (not positive)",
		...
		{
			name:       "Strong Sell rating - negative",
			action:     "downgraded by Deutsche Bank",
			ratingFrom: "Hold",
			ratingTo:   "Strong Sell",
			expected:   false,
		},
		{
			name:       "Neutral rating - not positive",
			action:     "initiated with neutral stance",
			ratingFrom: "",
			ratingTo:   "Neutral",
			expected:   false,
		},
		{
			name:       "Underperform rating - negative",
			action:     "downgraded due to concerns",
			ratingFrom: "Hold",
