...
func TestNewMarketDataIngestionUseCase(t *testing.T) {
	...
	useCase := marketdatausecase.NewMarketDataIngestionUseCase(mockRepo, mockClient, mockLogger)

	assert.NotNil(t, useCase)
	// Test that the use case was created successfully by calling a method
